...
class SignupActivity : AppCompatActivity(), AuthListener {
    ...
    private lateinit var pricingEditText: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pricingEditText = findViewById(R.id.et_pricing)
